...
if __name__=='__main__':
    # 121 k=32
    net = DenseNet(units=[6, 12, 24, 16], num_stage=4, growth_rate=32, num_class=100, data_type='imagenet')
    # 169 k=32
    net = DenseNet(units=[6, 12, 32, 32], num_stage=4, growth_rate=32, num_class=100, data_type='imagenet')
    # 201 k=32
    net = DenseNet(units=[6, 12, 48, 32], num_stage=4, growth_rate=32, num_class=100, data_type='imagenet')
    # 161 k=48
    net = DenseNet(units=[6, 12, 36, 24], num_stage=4, growth_rate=48, num_class=100, data_type='imagenet')