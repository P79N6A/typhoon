...
def resnet(units, num_stage, filter_list, num_class, data_type='imagenet', bottle_neck=True, bn_mom=0.9, workspace=512, memonger=False, loss_type='softmax'):
    ...
    _, output_shape, _ = fc1.infer_shape(data=(1, 3, 224, 224))
...
def focal_loss(pre, label, gamma=2):
    pre = pre + 1e-14
