...
def Circle_Middle(name, data, num_filter, bn_mom=0.9, round=8):
    b = data
...
def get_xception_symbol(num_classes=1000):
    ...
    # block 2
    rs2    = Conv(data=block1, num_filter=filter_list[1], stride=(2, 2), name='Entry_flow_b2_conv1', withBn=True, bn_mom=0.9, workspace=256)
    ...
    # block 3
    rs3    = Conv(data=block2, num_filter=filter_list[2], stride=(2, 2), name='Entry_flow_b3_conv1', withBn=True, bn_mom=0.9, workspace=256)
    ...
    # block 4
    rs4    = Conv(data=block3, num_filter=filter_list[3], stride=(2, 2), name='Entry_flow_b4_conv1', withBn=True, bn_mom=0.9, workspace=256)
    ...
    # Middle flow
    block_m_f = Circle_Middle('Middle_flow', block4, filter_list[3], 0.9, 8)
