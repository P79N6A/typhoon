...
def resnet(units, num_stage, filter_list, num_class, data_type='imagenet',
    ...
    if loss_type == 'softmax':
        ...
        pre_softmax = mx.symbol.softmax(fc1, name='softmax')
...
def get_symbol_resnet(depth, num_class=2, loss_type='softmax'):
    if depth == 18:
        units = [2, 2, 2, 2]
    elif depth == 34:
        units = [3, 4, 6, 3]
    ...
    net = resnet(units=units, num_stage=4, num_class=num_class, filter_list=filter_list, loss_type=loss_type)
    return net


if __name__ == '__main__':
    net = get_symbol_resnet(50, num_class=2, loss_type='focal')
